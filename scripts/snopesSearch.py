...
def retrieveSnopesInformationFor(searchString):
    articleLink = getFirstArticleLink(searchString)
    if (articleLink):
        return parseArticleInformation(articleLink)
    return None

def main():
    print(retrieveSnopesInformationFor(sys.argv[1]))
